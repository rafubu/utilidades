...
export const convertValue = await import('./src/url/index.ts').then(mod => mod.convertValue)
export const setvalue = await import('./src/url/index.ts').then(mod => mod.setvalue)